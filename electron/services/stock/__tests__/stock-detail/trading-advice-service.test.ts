...
vi.mock('../../anomaly/market-review-service', () => ({
  getMarketReview: vi.fn(),
}));

vi.mock('../../stock-detail/stock-client', () => ({
...
import { getDiscoverySnapshot } from '../../discovery/discovery-service.js';
import { getMarketReview } from '../../anomaly/market-review-service.js';
import { getTradingAdvice, reconcileAdviceLeaderStocks } from '../../stock-detail/trading-advice-service.js';
import { listDailyDragonTiger, listEastmoneySurgeByDate } from '../../stock-detail/stock-client.js';
import { sdk } from '../../quotes/shared.js';
