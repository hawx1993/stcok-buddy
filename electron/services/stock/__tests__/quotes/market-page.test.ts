...
vi.mock('../../quotes/industry-provider', () => industryProvider);
vi.mock('../../quotes/market-state', () => marketState);
vi.mock('../../quotes/market-indices', () => marketIndices);
vi.mock('../../quotes/shared', () => shared);

import { getMarketPageSnapshot } from '../../quotes/market-page.js';
