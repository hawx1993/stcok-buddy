...
vi.mock('../../stock-detail/stock-client', () => stockClient);
vi.mock('../../../stock-db/surge-history-store', () => surgeStore);

type TSurgeHistoryScheduler = typeof import('../../anomaly/surge-history-scheduler.js');
...
async function loadScheduler(): Promise<TSurgeHistoryScheduler> {
  ...
  return import('../../anomaly/surge-history-scheduler.js');
}
