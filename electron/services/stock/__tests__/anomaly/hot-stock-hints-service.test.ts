...
vi.mock('../../anomaly/surge-history-service', () => ({
...
type THotStockHintsService = typeof import('../../anomaly/hot-stock-hints-service.js');
...
beforeEach(async () => {
  ...
  service = await import('../../anomaly/hot-stock-hints-service.js');
});
