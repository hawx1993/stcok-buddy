...
vi.mock('../../monitor/monitor-service', () => monitorService);

type TMonitorHistoryScheduler = typeof import('../../monitor/monitor-history-scheduler.js');
...
async function loadScheduler(): Promise<TMonitorHistoryScheduler> {
  ...
  return import('../../monitor/monitor-history-scheduler.js');
}
