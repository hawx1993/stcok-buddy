...
type TMarketDataStore = typeof import('../../stock-db/market-data-store.js');
type TMonitorHistoryStore = typeof import('../../stock-db/monitor-history-store.js');
type TSurgeHistoryStore = typeof import('../../stock-db/surge-history-store.js');
...
async function loadModules() {
  ...
  vi.resetModules();
  marketStore = await import('../../stock-db/market-data-store.js');
  monitorStore = await import('../../stock-db/monitor-history-store.js');
  surgeStore = await import('../../stock-db/surge-history-store.js');
