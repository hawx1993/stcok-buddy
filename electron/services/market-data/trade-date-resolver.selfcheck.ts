...
const calendar: ITradingCalendarClient = {
  ...
  previousTradingDay: async (date) =>
    ({ '2026-07-23': '2026-07-22', '2026-07-25': '2026-07-23', '2026-10-08': '2026-09-30' })[date] ?? '2026-07-22',
};

assert.deepEqual(toShanghaiMarketTime(new Date('2026-07-23T01:29:00.000Z')), {
  date: '2026-07-23',
  minutes: 9 * 60 + 29,
});
