...
export function QuickEntry({ conversationId, onSubmit, slashItems }: {
      ...
      <div className={styles['qe-hero']} aria-hidden='true'>
        <svg viewBox='0 0 420 200' xmlns='http://www.w3.org/2000/svg'>
          ...
          <g stroke='var(--surface)' strokeWidth='0.5' opacity='0.75'>
            <line x1='40' y1='30' x2='380' y2='30' /><line x1='40' y1='60' x2='380' y2='60' />
            <line x1='40' y1='90' x2='380' y2='90' /><line x1='40' y1='120' x2='380' y2='120' />
            <line x1='40' y1='150' x2='380' y2='150' /><line x1='108' y1='30' x2='108' y2='150' />
            <line x1='176' y1='30' x2='176' y2='150' /><line x1='244' y1='30' x2='244' y2='150' /><line x1='312' y1='30' x2='312' y2='150' />
          </g>
...
function HintList({ hints, loading, onRefresh, onSelect }: { hints: IHotStockHint[]; loading: boolean; onRefresh(): void; onSelect(hint: IHotStockHint): void }) {
  if (loading) return <div className={styles['qe-hints']}><span className={styles['qe-hints-status']}>正在获取真实热点推荐…</span></div>;
  if (!hints.length) return <div className={styles['qe-hints']}><span className={styles['qe-hints-status']}>暂无真实热点推荐</span></div>;
  return (
    <div className={styles['qe-hints']}>
      ...
      <button className={styles['qe-hints-refresh']} onClick={onRefresh} type='button'>换一组</button>
    </div>
  );
}
