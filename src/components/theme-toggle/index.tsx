...
export function ThemeToggle({ compact = false }: { compact?: boolean }) {
  ...
  return (
    ...
    >
      {compact ? (
        <ThemeModeIcon theme={theme} className={`${styles['theme-icon']} ${iconModeClass}`} />
      ) : (
        <span className={`${styles['item-icon']} ${styles['theme-icon-wrap']} ${iconModeClass}`}>
...
function ThemeModeIcon({ theme, className }: { theme: 'dark' | 'light'; className?: string }) {
  if (theme === 'dark') {
    return (
      <svg className={className} width='16' height='16' viewBox='0 0 16 16' fill='none' aria-hidden='true'>
        ...
        <path
          d='M8 1.7v1.45M8 12.85v1.45M14.3 8h-1.45M3.15 8H1.7M12.45 3.55l-1.03 1.03M4.58 11.42l-1.03 1.03M12.45 12.45l-1.03-1.03M4.58 4.58 3.55 3.55'
          stroke='currentColor'
          strokeWidth='1.45'
          strokeLinecap='round'
        />
  ...
  return (
    <svg className={className} width='16' height='16' viewBox='0 0 16 16' fill='none' aria-hidden='true'>
      <path
        d='M12.72 10.25A5.55 5.55 0 0 1 5.76 3.28 5.85 5.85 0 1 0 12.72 10.25Z'
        stroke='currentColor'
        strokeWidth='1.45'
        strokeLinecap='round'
